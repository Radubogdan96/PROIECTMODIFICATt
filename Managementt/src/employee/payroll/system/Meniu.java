...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jButton5.setText("Update Salariu");
        ...
        jMenuItem6.setText("Angajat Raport");
        ...
        jMenuItem7.setText("Raport Salariu");
        ...
        jMenuItem2.setText("Raport Deductie");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        Cautare_Angajat e = new Cautare_Angajat();
        e.setVisible(true);
        dispose();
    ...
    private void add_employeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_employeeActionPerformed
        // TODO add your handling code here:
        Adaugare_Angajat x = new Adaugare_Angajat();
        x.setVisible(true);
        dispose();
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
       JFileChooser dialog = new JFileChooser();
        ...
        try {
          ...
          myDocument.add(new Paragraph("Angajati  Lista",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
    ...
    private void jMenuItem7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem7ActionPerformed
        ...
        try {
           ...
           myDocument.add(new Paragraph("Lista Angajati Salariu",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
           myDocument.add(new Paragraph(new Date().toString()));
           myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Deductie_Angajat x = new Deductie_Angajat();
         x.setVisible(true);
         dispose();
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        // TODO add your handling code here:
            ...
            JFileChooser dialog = new JFileChooser();
            dialog.setSelectedFile(new File("Raport Deductie Angajati.pdf"));
            int dialogResult = dialog.showSaveDialog(null);
            if (dialogResult==JFileChooser.APPROVE_OPTION){
            String filePath = dialog.getSelectedFile().getPath();
        ...
        try {
           ...
           myDocument.add(new Paragraph("Lista Deductie Angajati",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
           myDocument.add(new Paragraph(new Date().toString()));
           myDocument.add(new Paragraph("-------------------------------------------------------------------------------------------"));
          table.addCell(new PdfPCell(new Paragraph("ID",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
          table.addCell(new PdfPCell(new Paragraph("First Name",FontFactory.getFont(FontFactory.TIMES_ROMAN,10,Font.BOLD))));
